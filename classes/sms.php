...
global $domains = array("tmomail.net",			# T-Mobile
...
function send_sms($number) {
	...
	$result = mysql_query("SELECT phone,provider FROM numbers WHERE number='".filter_var($number,FILTER_SANITIZE_STRING).'"', $conn);
...
send_sms("6469572487") or die "Fuck.";
